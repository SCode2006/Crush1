...
function setup() {
  ...
  bridge = new Bridge(40,{x:300,y:height/2});
  ...
  rock3 = new Stone((width/2)-40,(height/2)-700);
  rock4 = new Stone((width/2)-60,(height/2)-700);
  rock5 = new Stone((width/2)+20,(height/2)-700);
  rock6 = new Stone((width/2)+40,(height/2)-700);
  rock7 = new Stone((width/2)+60,(height/2)-700);
  rock8 = new Stone((width/2)+80,(height/2)-700);
